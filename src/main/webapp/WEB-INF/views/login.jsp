...
<div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('<c:url value="/resources/images/pexels-cottonbro-studio-3585089.jpg" />'); height: 100vh !important;"></div>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    ...
                    <div class="text-center mt-4">
                        <h3>Login to <strong>CNSS</strong></h3>
                    </div>
                    <form action="${url}users/login" method="POST">
                        ...
                        <div class="d-flex mb-5 align-items-center">
                            <input type="submit" value="Login" class="btn btn-flex w-100 btn-primary">
                        </div>
